 ...
 *         &lt;element name="payment_profile_identifiers" type="{http://soap.drupal.glynlyon.com}stringArray"/>
...
public class Address {
    ...
    @XmlElement(name = "payment_profile_identifiers", required = true, nillable = true)
    protected StringArray paymentProfileIdentifiers;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the newToHomeSchooling property.
     * 
     */
    public boolean isNewToHomeSchooling() {
        return newToHomeSchooling;
    }

    /**
     * Sets the value of the newToHomeSchooling property.
     * 
     */
    public void setNewToHomeSchooling(boolean value) {
        this.newToHomeSchooling = value;
    }
     ...
     *     
     */
    public StringArray getPaymentProfileIdentifiers() {
     ...
     *     
     */
    public void setPaymentProfileIdentifiers(StringArray value) {
